...
public class PainelClientePF extends JPanel
{
    JFormattedTextField textFieldCep , textFieldTelefonePri , textFieldTelefoneSec;
    PessoaFisica pessoa;
    
    public PainelClientePF(JPanel painelPai , PessoaFisica pessoaPesquisada)
    {
        ...
        JTextField textFieldNome = new JTextField(pessoa.getNome());
        ...
        textFieldNome.setDisabledTextColor(Color.BLACK);

        JPanel painelNome = new JPanel();
        painelNome.setLayout(new BoxLayout(painelNome , BoxLayout.PAGE_AXIS));
        painelNome.setPreferredSize(new Dimension(200 , 50));
        painelNome.setBounds(118 , 93 , 200 , 50);
        ...
        labelCpf.setBounds(0 , 0 , 200 , 25);

        JTextField textFieldCpf = new JTextField(pessoa.getCpf());
        textFieldCpf.setAlignmentX(Component.LEFT_ALIGNMENT);
        textFieldCpf.setPreferredSize(new Dimension(200 , 25));
        textFieldCpf.setBounds(0 , 0 , 200 , 25);
        textFieldCpf.setEnabled(false);
        textFieldCpf.setDisabledTextColor(Color.BLACK);

        JPanel painelCpf = new JPanel();
        painelCpf.setLayout(new BoxLayout(painelCpf , BoxLayout.PAGE_AXIS));
        painelCpf.setPreferredSize(new Dimension(200 , 50));
        painelCpf.setBounds(118 , 154 , 200 , 50);

        painelCpf.add(labelCpf);
        painelCpf.add(textFieldCpf);
        ...
        String[] camposAChecar = {textFieldNome.getText() , textFieldTelefonePri.getText() , textFieldLogradouro.getText() ,
                ...
                if (! ValidadorCampos.checarSeHaVazio(camposAChecar))
                {
                    ...
                    switch (opcao)
                    {
                        case JOptionPane.YES_OPTION:
                            GerenciadorClientes.alterarPessoaFisica(pessoa.getCliente().getIdCliente() , textFieldTelefonePri.getText() , textFieldTelefoneSec.getText() , textFieldEmail.getText() ,
                                            ...
                                            textFieldNome.getText() , textFieldCpf.getText());
        ...
        botaoCancelar.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                pessoa = PessoaFisicaDAO.buscarPorCpf(pessoaPesquisada.getCpf());
